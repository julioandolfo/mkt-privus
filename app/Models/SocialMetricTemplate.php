...
class SocialMetricTemplate extends Model
{
    ...
    public static function getDefaults(): array
    {
        return [
            ...
            ['platform' => 'youtube', 'metric_key' => 'video_views', 'name' => 'Visualizacoes', 'description' => 'Total de visualizacoes do canal', 'unit' => 'number', 'direction' => 'up', 'aggregation' => 'last', 'color' => '#FF0000', 'icon' => 'play', 'category' => 'engagement', 'sort_order' => 2],
            ['platform' => 'youtube', 'metric_key' => 'posts_count', 'name' => 'Total de Videos', 'description' => 'Quantidade total de videos publicados', 'unit' => 'number', 'direction' => 'up', 'aggregation' => 'last', 'color' => '#FF0000', 'icon' => 'video', 'category' => 'content', 'sort_order' => 3],
            ['platform' => 'youtube', 'metric_key' => 'likes', 'name' => 'Curtidas', 'description' => 'Total de curtidas nos videos', 'unit' => 'number', 'direction' => 'up', 'aggregation' => 'sum', 'color' => '#FF0000', 'icon' => 'thumbs-up', 'category' => 'engagement', 'sort_order' => 4],
            ['platform' => 'youtube', 'metric_key' => 'comments', 'name' => 'Comentarios', 'description' => 'Total de comentarios nos videos', 'unit' => 'number', 'direction' => 'up', 'aggregation' => 'sum', 'color' => '#FF0000', 'icon' => 'message-circle', 'category' => 'engagement', 'sort_order' => 5],
            ['platform' => 'youtube', 'metric_key' => 'watch_time_minutes', 'name' => 'Tempo de Exibicao', 'description' => 'Minutos totais assistidos', 'unit' => 'number', 'value_suffix' => 'min', 'direction' => 'up', 'aggregation' => 'sum', 'color' => '#FF0000', 'icon' => 'clock', 'category' => 'engagement', 'sort_order' => 6],
            ...
            ['platform' => 'tiktok', 'metric_key' => 'posts_count', 'name' => 'Total de Videos', 'description' => 'Quantidade total de videos publicados', 'unit' => 'number', 'direction' => 'up', 'aggregation' => 'last', 'color' => '#000000', 'icon' => 'video', 'category' => 'content', 'sort_order' => 4],
            ...
            ['platform' => 'linkedin', 'metric_key' => 'clicks', 'name' => 'Cliques', 'description' => 'Cliques no conteudo', 'unit' => 'number', 'direction' => 'up', 'aggregation' => 'sum', 'color' => '#0A66C2', 'icon' => 'mouse-pointer', 'category' => 'conversion', 'sort_order' => 4],
            ...
            ['platform' => 'pinterest', 'metric_key' => 'saves', 'name' => 'Salvamentos', 'description' => 'Pins salvos pelos usuarios', 'unit' => 'number', 'direction' => 'up', 'aggregation' => 'sum', 'color' => '#E60023', 'icon' => 'bookmark', 'category' => 'engagement', 'sort_order' => 3],
            ['platform' => 'pinterest', 'metric_key' => 'clicks', 'name' => 'Cliques no Link', 'description' => 'Cliques em links dos pins', 'unit' => 'number', 'direction' => 'up', 'aggregation' => 'sum', 'color' => '#E60023', 'icon' => 'mouse-pointer', 'category' => 'conversion', 'sort_order' => 4],
        ];
    }
